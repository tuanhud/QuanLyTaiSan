...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <dx:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" Theme="Youthful" Width="100%">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="Tên gọi" FieldName="hoten" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Tài khoản" FieldName="username" VisibleIndex="2">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Ngày tạo" FieldName="date_create" VisibleIndex="3">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Ngày chỉnh sửa" FieldName="date_modified" VisibleIndex="4">
                    </dx:GridViewDataTextColumn>
                </Columns>
