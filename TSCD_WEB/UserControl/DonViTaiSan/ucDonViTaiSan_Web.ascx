                ...
                <table id="tableinfo">
                    <tr>
                        <h3 class="title_green fix">
                            ...
                            <a href="javascript:;" onclick='_ShowFull("DonViTaiSanFull.aspx?key=<% Response.Write(Request.QueryString["key"]); %>")'><i class="glyphicon glyphicon-fullscreen"></i></a>&nbsp;Danh sách tài sản
                        </h3>
