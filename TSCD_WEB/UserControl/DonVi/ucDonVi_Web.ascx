<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucDonVi_Web.ascx.cs" Inherits="TSCD_WEB.UserControl.DonVi.ucDonVi_Web" %>
...
<table class="table largetable">
    <tbody>
        ...
        <tr id="infotr" runat="server" visible="false">
            ...
            <td id="ChuaChonDonVi" runat="server" visible="false">
                <uc:ucWarning runat="server" ID="ucWarning_ChuaChonDonVi" />
            </td>
