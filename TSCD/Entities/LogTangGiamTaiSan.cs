...
namespace TSCD.Entities
{
    ...
    /// </summary>
    [Table("LOGTANGGIAMTAISANS")]
    public class LogTangGiamTaiSan:_EntityAbstract1<LogTangGiamTaiSan>
    {
        public LogTangGiamTaiSan():base()
        {
        ...
        /// <summary>
        /// tang giam toan truong
        /// , +1: tang, -1: giam, 0: backup
        /// </summary>
        public int tang_giam { get; set; }
        /// <summary>
        /// tang giam toan truong
        /// ,+1: tang, -1: giam, 0: backup
        /// </summary>
        public int tang_giam_donvi { get; set; }
        /// <summary>
        /// +1: chuyen den, -1: chuyen di, 0: khong thuoc 2 th tren
        /// </summary>
        public int chuyenden_chuyendi { get; set; }
