<%@ Page Title="" Language="C#" MasterPageFile="~/PopupMasterPage.Master" AutoEventWireup="true" CodeBehind="HinhAnh.aspx.cs" Inherits="PTB_WEB.HinhAnh" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.: Hình ảnh :: Quản lý Thiết bị :.</title>
</asp:Content>
