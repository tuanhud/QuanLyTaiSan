<%@ Page Language="C#" MasterPageFile="~/PopupMasterPage.Master" AutoEventWireup="true" CodeBehind="LogThietBi.aspx.cs" Inherits="PTB_WEB.UserControl.PhongThietBi.LogThietBi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.: Log thiết bị :: Quản lý Thiết bị :.</title>
</asp:Content>
